...
! function(t, e) {
    ...
    return function(t) {
        ...
        function c(t, e, n) {
            S(t).add('switch', 'switch-' + (C.includes(e.size) ? e.size : 'default'), e.checked ? j : M), h.call(n), a.call(n), l.call(n), f.call(n, n._options.disabled)
        }
        ...
        r.prototype._init = function(t, e) {
            ...
            this._options.beforeDestroy.call(this, this._el.checked), v(this._events, this), this._options.onDestroy.call(this)
        ...
        t.exports = function(t) {
            if (void 0 == t) throw TypeError('Cannot call method on  ' + t);
            return t
        }
    }, function(t, e, n) {
        'use strict';
        ...
        t.exports = function(t, e, n, _, m, w, k) {
            ...
            if (N && (E = l(N.call(new t)), E !== Object.prototype && (f(E, C, !0), o || s(E, h) || c(E, h, g))), T && M && M.name !== y && (O = !0, A = function() {
                    return M.call(this)
                }), o && !k || !p && !O && j[h] || c(j, h, A), u[e] = A, u[C] = g, m)
                if (x = {
                        values: T ? A : S(y),
                        keys: w ? A : S(v),
                        entries: L
        ...
        t.exports = Object.create || function(t, e) {
            var n;
            return null !== t ? (s[u] = o(t), n = new s, s[u] = null, n[c] = t) : n = a(), void 0 === e ? n : r(n, e)
        }
    }, function(t, e, n) {
        var o = n(22),
            r = n(23),
        ...
        t.exports = {
            getConstructor: function(t, e, n, f) {
                var l = t(function(t, o) {
                    s(t, l, e, '_i'), t._i = r(null), t._f = void 0, t._l = void 0, t[v] = 0, void 0 != o && a(o, n, t[f], t)
                });
        ...
        var o = n(44)('meta'),
            ...
            p = function(t) {
                return a && d.NEED && u(t) && !i(t, o) && f(t), t
            },
            d = t.exports = {
                KEY: o,
                NEED: !1,
        ...
        t.exports = function(t, e, n, y, g, _) {
            ...
            return v && 'function' == typeof w && (_ || x.forEach && !c(function() {
                ...
                f(e, w, t, '_c'), e._c = new m, void 0 != n && a(n, g, e[k], e)
            }), d('add,clear,delete,forEach,get,has,set,keys,values,entries,toJSON'.split(','), function(t) {
                var e = 'add' == t || 'set' == t;
                t in x && (!_ || 'clear' != t) && s(w.prototype, t, function(n, o) {
            ...
            })) : (w = y.getConstructor(e, t, g, k), u(w.prototype, n), i.NEED = !0), h(w, t), b[t] = w, r(r.G + r.W + r.F, b), _ || y.setStrong(w, t, g), w
        }
    }, function(t, e, n) {
        var o = n(19),
            r = n(11),
        ...
        t.exports = function(t) {
            return function() {
                if (o(this) != t) throw TypeError(t + '#toJSON is not generic');
                return r(this)
            }
        }
    }, function(t, e, n) {
        ...
        o.prototype.add = function() {
            var t, e;
            for (e = 0; e < arguments.length; e += 1) t = '' + arguments[e], r(this, t) >= 0 || c.push.call(this, t);
            return this._elem.className = this.toString(), this
        }, o.prototype.remove = function() {
            var t, e, n;
            for (n = 0; n < arguments.length; n += 1) e = '' + arguments[n], t = r(this, e), t < 0 || c.splice.call(this, t, 1);
            return this._elem.className = this.toString(), this
